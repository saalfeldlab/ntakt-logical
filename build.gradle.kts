...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("ntakt-logical")
                url.set("https://github.com/saalfeldlab/ntakt-logical")
                ...
                scm {
                    connection.set("scm:git:git://github.com/saalfeldlab/ntakt-logical")
                    developerConnection.set("scm:git:git@github.com:saalfeldlab/ntakt-logical")
                    tag.set("HEAD")
                    url.set("https://github.com/saalfeldlab/ntakt-logical")
                }
                ciManagement {
                    system.set("Travis CI")
                    url.set("https://travis-ci.com/saalfeldlab/ntakt-logical")
                }
                repositories {
